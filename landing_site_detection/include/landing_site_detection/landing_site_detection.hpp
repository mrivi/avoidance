...
public:
  ...
  **/
  void dynamicReconfigureSetParams(const landing_site_detection::LandingSiteDetectionNodeConfig& config, uint32_t level);
...
protected:
  ...
  landing_site_detection::LandingSiteDetectionNodeConfig rqt_param_config_;
