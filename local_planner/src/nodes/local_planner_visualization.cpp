...
void LocalPlannerVisualization::initializePublishers(ros::NodeHandle& nh) {
  ...
  closest_point_pub_ = nh.advertise<visualization_msgs::MarkerArray>("/closest_point", 1);
  deg60_point_pub_ = nh.advertise<visualization_msgs::MarkerArray>("/deg60_point", 1);
}
...
void LocalPlannerVisualization::publishPoints( Eigen::Vector3f &closest_pt,  Eigen::Vector3f &deg60_pt) {

  visualization_msgs::MarkerArray marker_closest_pt;
  visualization_msgs::MarkerArray marker_deg60_pt;
  ...
  marker_closest_pt.markers.push_back(m);
  closest_point_pub_.publish(marker_closest_pt);
  ...
  marker_deg60_pt.markers.push_back(m);
  deg60_point_pub_.publish(marker_deg60_pt);
}
